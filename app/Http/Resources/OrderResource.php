...
class OrderResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'seller_fee'                    => $this->when($this->rate_total_price, $this->rate_total_price - $this->rate_delivery_fee - $this->rate_service_fee - $this->rate_commission_fee - $couponPrice - $this->point_histories_sum_price),
